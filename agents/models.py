"""
Pydantic v2 schemas and data definitions for Merkle Mountain Range Mmr.
...
class SystemTaskPayload(BaseModel):
    ...
    def validate_metric_finite(cls, v: float) -> float:
        """Reject NaN and infinite values which indicate sensor/algorithm faults."""
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "merkle-mountain-range-mmr"
